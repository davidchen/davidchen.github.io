...
! function() {
    ...
    if (window.FontAwesomeCdnConfig && (e = window.FontAwesomeCdnConfig, f = e.useUrl, g = e.faCdnUrl, h = e.code, i = "FontAwesome", j = "fa", k = "", l = e.webFontLoaderVersion, e.autoA11y.enabled && (a(d.bind(d, "fa")), c(d.bind(d, "fa"))), e.reporting.enabled && b(e.reporting.domains, location.host) && q.load("/js/fa-stats.js"), n = "/css/fa-de05a4e1f9.css", m = "/js/fa-webfontloader.js", e.asyncLoading.enabled ? p.loadAsync(n, i, k, m) : p.load(n)), window.FortAwesomeConfig) {
        var r;
